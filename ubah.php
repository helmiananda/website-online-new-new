                ...
                <form action="" method="post">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" class="input" name="no_surat_keterangan" id="no_surat_keterangan" required value="<?= $input_data_surat["no_surat_keterangan"]; ?>">
                        </li> <br>
                        <li>
                            <label for="">No Surat</label>
                            <input type="text" class="input" name="no_surat_keterangan_berdomisili" id="no_surat_keterangan_berdomisili" required value="<?= $input_data_surat["no_surat_pengantar"]; ?>">
                        </li> <br>
                        <li>
                            <label for="">No Surat</label>
                            <input type="text" class="input" name="no_surat_pengantar" id="no_surat_pengantar" required value="<?= $input_data_surat["no_surat_keterangan_berdomisili"]; ?>">
                        </li> <br>
